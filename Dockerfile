...
ENV \
    PATH="/opt/julia/bin:/opt/julia-1.5/bin:/opt/julia/bin:/opt/julia-1.4/bin:/opt/julia-1.3/bin:/opt/julia-1.0/bin:$PATH" \
...
RUN provisioning/install-sw.sh nodejs-bindist 12.16.2 /opt/nodejs
